...
CALIBRATION_MIN_RAW_DELTA = float(os.getenv("MEOWTON_CALIBRATION_MIN_RAW_DELTA", "10"))
CALIBRATION_NOISE_MULTIPLIER = float(os.getenv("MEOWTON_CALIBRATION_NOISE_MULTIPLIER", "5.0"))
